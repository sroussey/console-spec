    ...
    function (tt, utils) {
        return {
            ...
            run:    function (conf, doc, cb) {
                ...
                // --- RUN THE TEMPLATES
                tt.loadRemote(conf.respecBase + "js/templates/w3c-headers.html", doc, function () {
                ...
                // --- RUN THE TEMPLATES (old version, using simplate)
                // simplate.loadRemote(conf.respecBase + "js/templates/w3c-headers.html", doc, function () {
                //     progress("running simplate for headers");
                //     // headers
                //     $("body", doc).prepend($(simplate.exec("w3c-headers", conf)));
                // 
                //     // abstract
                //     progress("handling abstract");
                //     var $abs = $("#abstract");
                ...
                //     // SotD
                //     progress("running simplate for sotd");
                //     $abs.after($(simplate.exec("w3c-sotd", conf)));
                //     
                //     // conformance
                //     progress("handling conformance");
                //     var $confo = $("#conformance");
                //     if ($confo) {
                //         $confo.prepend($(simplate.exec("w3c-conformance", conf)));
                //         $confo.prepend("<h2>Conformance</h2>");
                //     }
                //     
                //     progress("done adding document headers");
